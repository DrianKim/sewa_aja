            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="jenis" id="jenis" required
                        class="block w-full py-3 pl-12 pr-4 text-gray-900 placeholder-gray-400 transition-all duration-200 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 hover:border-gray-400 @error('jenis') border-red-500 @enderror"
